...
" see: https://github.com/Xantibody/markdown-preview.nvim/issues/50
Plug 'Xantibody/markdown-preview.nvim', { 'do': { -> mkdp#util#install() }, 'for': ['markdown', 'vim-plug']}


" If you have nodejs
Plug 'Xantibody/markdown-preview.nvim', { 'do': 'cd app && npx --yes yarn install' }
```

Or install with [dein](https://github.com/Shougo/dein.vim):

```vim
call dein#add('Xantibody/markdown-preview.nvim', {'on_ft': ['markdown', 'pandoc.markdown', 'rmd'],
...
```vim
call minpac#add('Xantibody/markdown-preview.nvim', {'do': 'packloadall! | call mkdp#util#install()'})
```
...
```vim
Plugin 'Xantibody/markdown-preview.nvim'
```
...
use({ "Xantibody/markdown-preview.nvim", run = "cd app && npm install", setup = function() vim.g.mkdp_filetypes = { "markdown" } end, ft = { "markdown" }, })
```

Or by hand:

```vim
use {'Xantibody/markdown-preview.nvim'}
```
...
git clone https://github.com/Xantibody/markdown-preview.nvim.git
...
" For more details see: https://github.com/Xantibody/markdown-preview.nvim/pull/9
" default empty
let g:mkdp_open_ip = ''
...
> checkout [issue 199](https://github.com/Xantibody/markdown-preview.nvim/issues/199) for more detail.
...
- [markdown.css](https://github.com/Xantibody/markdown.css)
...
![btc](https://img.shields.io/keybase/btc/Xantibody.svg?style=popout-square)
