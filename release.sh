...
GH_REPO="$GH_API/repos/Xantibody/markdown-preview.nvim"
...
do
  GH_ASSET="https://uploads.github.com/repos/Xantibody/markdown-preview.nvim/releases/$id/assets?name=$filename"
